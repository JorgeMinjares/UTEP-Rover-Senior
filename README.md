...
## **Objective** 
The objective of this project is to automate soil data acquisition. The rover is designed to maneuver between the crop fields and probe the soil with sensors to acquire data. Once the system processes the information, it is sent over to the GUI and displays it to the user. 
## **Team Members**
- Octavio Galindo
